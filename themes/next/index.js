...
const LayoutBase = props => {
  const { children, headerSlot, floatSlot, rightAreaSlot, siteInfo, meta } =
    props
    ...
    <div id="theme-next">
      ...
      >
        ...
        <section
          id="container-inner"
          className={`${
            CONFIG.NAV_TYPE !== 'normal' ? 'mt-24' : ''
          } lg:max-w-3xl xl:max-w-4xl flex-grow md:mt-0 min-h-screen w-full relative z-10`}
          ref={targetRef}
        >
          <Transition
            show={!onLoading}
      ...
      <div
        ...
        className="right-8 bottom-12 lg:right-2 fixed justify-end z-20 font-sans"
      >
        <div
          className={
